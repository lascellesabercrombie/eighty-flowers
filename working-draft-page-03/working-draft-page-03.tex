...
in summer to $\stackrel{\hbox{fruit}}{\hbox{\sout{???}}}$ the upper stem\par
...
\tickitem .. leaves heartsh-shaped margins toothed ..\par
...
\setulcolor{blue}
L. Nepeta > Etrurian city .. /$\caretinsert$ $\stackrel{\hbox{species}}{\hbox{Nepeta}}$\par
...
\begin{textblock*}{3.22in}(0.5cm,19cm)%
  ...
  \begin{textblock*}{3.22in}(0.5cm,25.5cm)%
	...
	\end{minipage}%
  \end{textblock*}%
\begin{textblock*}{3.22in}(0.5cm,27cm)%
	\tiny
	\begin{minipage}{3.22in} 
		\color{blue}
		L.
...
\begin{textblock*}{3.22in}(0.5cm,29cm)%
	\tiny
	\begin{minipage}{3.22in} 
		\color{red}
		\Circled{
