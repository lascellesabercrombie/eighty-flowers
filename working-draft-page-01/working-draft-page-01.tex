...
\newcommand{\smallundertick}{
	\begin{tikzpicture}[remember picture,overlay]
		\draw (-0.55,-0.1) -- (-0.5,-0.2);
		\draw (-0.5,-0.2) -- (-0.1,0);
	\end{tikzpicture}
}
...
for the most part but in the gar$\mediumtick$dens of gre$\mediumtick$at persons, doth\par
ca$\mediumtick$use it to be of gre$\mediumtick$at regard''
...
\end{tikzpicture}
(lily family)
\item \ulfelttip{\color{blue} thyme}$\smallundertick$ (\ulfelttip{\color{blue}\ul{time}})$\smallundertick$ (Pt. J. {$\stackrel{\hbox{Aug-}}{\hbox{Sep}}$}74) ($\stackrel{\hbox{see \#70}}{\hbox{pVI v.i}}$
\begin{tikzpicture}[remember picture,overlay,line width=0.05in,opacity=0.6]
    \color{red}
...
\color{blue}
\item Nyssa sylv$\bigfelttiptick$atica Pt J 306 {$\stackrel{\hbox{- identified?}}{\hbox{E Brway Nov 3/74}}$}
\begin{tikzpicture}[remember picture,overlay]
