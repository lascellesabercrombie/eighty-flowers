...
\color{blue}
\begin{flushright}
\Circled{Notes \& orig. drafts (?) page 1}\\
\end{flushright}
\begin{flushleft}
\color{red} 
\begin{turn}{25}%
...
\color{red}for the 80 listed on ppI-VI) \hfill \color{blue} \Circled{{$\stackrel{\hbox{orig p \#}}{\hbox{IA-B}}$}}\\

\color{red}
\small
\Circled{3} perennial .. weedy .. Eurasian .. poppy family .. {$\stackrel{\hbox{called also}}{\hbox{killwort sightwort}}$}\\
...
\Circled{2} the lesser celandine or pilewort, still used in home med. for piles\\
...
\color{blue}
\normalsize
\Circled{$\stackrel{\hbox{\color{red}{*See:}}}{\hbox{\color{blue}{pp.40-42}}}$} Port Jefferson planted Oct 18/74)\\
%pp.40-42 circled in red below *See:
\color{red}
\small
\Circled{1} (Wordsworth's poems refer to \ul{Ranunculus ficaria}, a crowfoot.\\
see \# 65 vi pV 
...
\tiny
\newsavebox{\abc}
\savebox{\abc}{\parbox{0.5in}{How great fallen are the great L.Z.}}%
...
(identified as follow at Rose Soc. [Suffolk])
