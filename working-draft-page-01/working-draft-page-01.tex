...
\Circled{2} $\rightarrow$ the lesser celandine or pilewort, still used in home med. for piles\\
...
\normalsize
\color{red}
\Circled{$\stackrel{\hbox{{*See:}}}{\hbox{\color{blue}{pp.40-42}}}$} \color{blue}Port Jefferson planted Oct 18/74)\\
