...
\usepackage{xcolor}
\usepackage[paperwidth=5.5in, paperheight=13.5in,  top=0.1in, bottom=0.1in, left=0.6in, right=0.4in]{geometry}
...
\begin{textblock*}{3cm}(2.5cm,14cm)%
	\begin{minipage}{3cm} 
        ...
        \textbf{(one word}\par
        $\transparent{1}\color{blue}\mediumtickright$\textbf{2 hyphens)}\par
	\end{minipage}%
\end{textblock*}%
...
\begin{textblock*}{8cm}(6cm,12cm)%
	\begin{minipage}{8cm} 
        ...
        taught at U. of London. Prof. (See\par
...
\begin{hangparas}{2em}{1}
        \textit{Century Dictionary} - defs. for Campanula, harebell (quote from \textit{Cymbeline})\par
        Everett, \textit{A Guide to Wild Flowers: Field Flowers} - entry for Venus's-Looking-Glass (9)\par
        \textit{Gray's Manual of Botany} - entries for Speculària Fabricius (1350-51), Camássia (436-437); defs. for clestogamous (1572), subulate (1583)\par
        Onions, \textit{A Shakespeare Glossary} - def. for hare-bell.\par
        Shakespeare, ``Venus and Adonis''\par
        \textit{Taylor's Encyclopedia of Gardening} - entries for Specularia (1135), Campanula (182-183)\par
\end{hangparas}
}
