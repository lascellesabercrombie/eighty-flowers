...
\usepackage{xcolor}
\usepackage[paperwidth=5.5in, paperheight=20in,  top=0.1in, bottom=0.1in, left=0.6in, right=0.4in]{geometry}
...
was \ulfelttip{Spec}\ul{ularia} $\color{red}\mediumcrossright$\ul{perfoliata}:\par
...
\begin{textblock*}{8cm}(6cm,12cm)%
	\begin{minipage}{8cm} 
        ...
        $\color{blue}\lineofsmallticks$\ulfelttip{[bell = looking-glass L. Z.]}\par
        \ul{Century}:
        ...
        W.S. \sout{Shak.} Cym.IV 2: \ul{The azur'd hare-bell}\par
        \ul{like thy veins} \Longstack{{222} {}} \Longstack{John Lindley} \Longstack{1799 -1865}\par
