...
\begin{textblock*}{6cm}(8cm,1.4cm)%
	\begin{minipage}{6cm} 
        ...
        \setul{}{2pt}
        $\color{red}\mediumcrossright$\ul{leaves} $\color{red}\mediumcrossright$\ul{alternate}\par
        margins sometimes toothed to 1 1/2" L \par
        1-3 \ul{flower} \ul{clusters} \sout{flwr} deep blue\par
        Sometimes$\color{red}\mediumcrossabove$ white, $\color{red}\smalltickright$\ul{erect} $\color{red}\mediumcrossaboveright$\ul{habit}\par
        {[i.e. $\color{red}\smalltickright$\ul{"bell"} $\color{red}\smalltickright$\ul{upright}]}\par		
	\end{minipage}%
\end{textblock*}%
